...
// import GroupAward from '../tiles/GroupAward';

const AddGroupAward = ({ profile: { profile }, addAward }) => {
      ...
      <div id='prof-exp'>
        <div className='prof-exp-container'>
          ...
          {/* {profile.awards === null ? (
            ...
            <GroupAward key={profile.awards._id} awardss={profile.awards} />
          )} */}
