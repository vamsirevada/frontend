...
const Invite = ({ isAuthenticated, sendReferral, setAlert }) => {
          ...
          <div className="login-column">
            <div className="signup-top">
              ...
              <p className="signup-para">
                Enter your friends/colleagues Email-ids, so we
                send them referral code to join us!
              </p>
            </div>
            <br />
...
export default connect(mapStateToProps, { setAlert, sendReferral })(Invite);
